package com.booleans.taskmanagement.dataloader;
...
import com.booleans.taskmanagement.service.RoleService;
...
public class InitialDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        taskService.createTask(new Task(
                ...
                "Set up first meeting with client. Collect basic data about the client. Define and collect briefing document from client.",
                today.minusDays(40),
                true,
